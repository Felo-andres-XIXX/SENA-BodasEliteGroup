...
<body>
  <div class="fuente-1">
  <p class="heading">Nuestros Servicios</p>
</div>
  <div class="gallery-image">
    <div class="img-box">
      <img src="css/img/cristaleria.jpg" alt="" />
      <div class="transparent-box">
        <div class="caption">
          <p>Cristaleria</p>
          <p class="opacity-low">Tipos de Cristaleria para todas las ocaciones</p>
        </div>
      </div> 
    </div>
    <div class="img-box">
      <img src="css/img/utensilios.jpg" alt="" />
      <div class="transparent-box">
        <div class="caption">
          <p> Utensilios</p>
          <p class="opacity-low">Utensilios para los eventos</p>
        </div>
      </div>
    </div>
    <a href="decoracion.php">
    <div class="img-box">
      <img src="css/img/sonidos.jpg" style="width: 100%" alt="" />
      <div class="transparent-box">
        <div class="caption">
          <p>Decoración</p>
          <p class="opacity-low">Sonido e iluminación Perzonalizado y especializado para cada evento</p>
        </div>
      </div>
    </div></a>
   
    <div class="img-box">
      <img src="css/img/mobiliario.jpg" alt="" />
      <div class="transparent-box">
        <div class="caption">
          <p>Mobiliario</p>
          <p class="opacity-low"> Tenemos todo lo que puede tener su evento  para su comodidad</p>
        </div>
      </div> 
    </div>
    <a href="enlace.php">
    <div class="img-box">
      <img src="css/img/salon.jpg" alt="" />
      <div class="transparent-box">
        <div class="caption">
          <p>Salones </p>
          <p class="opacity-low"> Espacios adecuados para su necesidad y gustos en cada evento</p>
        </div>
      </div> 
    </div></a>
      </div> 
