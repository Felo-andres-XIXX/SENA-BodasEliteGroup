...
<div id="header" align="center">
  <a id="logo"><h1>¿Quienes somos?</h1></a>
  <br></br>
 <div class="form">
		<h3>Somos una empresa organizadora y productora de eventos sociales y empresariales creada hace año y medio pero con una experiencia de 20 años de los socios. Se especializa en  Bodas 15 años, cumpleaños , despedidas de fin de año y eventos de empresas y nuestro proposito es la satisfaccion total de nuestros clientes.</h3>

	</div> <img src="img/ev.jpg" style="width: 50%">
