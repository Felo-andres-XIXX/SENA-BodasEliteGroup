...
<head>
  <title>Buffet</title>
  <link href="https://https://fonts.google.com/specimen/Squada+One :600,900" rel="stylesheet">
</head>
<body>
  <div class="fuente-1">
  <p class="heading">Buffet</p>
</div>
<a href="comidaEntrada.php">
  <div class="gallery-image">
    <div class="img-box">
      <img src="css/img/entrada.jpg" alt="" />
      <div class="transparent-box">
        <div class="caption">
          <p>Platos de entrada</p>
         
          <p class="opacity-low">Tipo de entradas a sus eventos</p>
        </div>
      </div> 
    </div></a>
    <div class="img-box">
      <img src="css/img/fuerte.jpg" alt="" />
      <div class="transparent-box">
        <div class="caption">
          <p>Comidas fuertes</p>
          <p class="opacity-low">Comidas fuertes para sus eventos</p>
        </div>
      </div>
    </div>
    <div class="img-box">
      <img src="css/img/postre.jpg" alt="" />
      <div class="transparent-box">
        <div class="caption">
          <p>Postres</p>
          <p class="opacity-low">Deliciosos postres para sus eventos</p>
        </div>
      </div>
    </div>
    <div class="img-box">
      <img src="css/img/Ponque.jpg" alt="" />
      <div class="transparent-box">
        <div class="caption">
          <p>Ponques</p>
          <p class="opacity-low">Pasteles y ponques para sus eventos especiales</p>
        </div>
      </div> 
    </div>
    <div class="img-box">
      <img src="css/img/bebidas.jpg" alt="" />
      <div class="transparent-box">
        <div class="caption">
          <p>Bebidas</p>
          <p class="opacity-low">Bebidas para cualquier ocación</p>
        </div>
      </div> 
    </div>
      <div class="img-box">
      <img src="css/img/otros.jpg" alt="" />
      <div class="transparent-box">
        <div class="caption">
          <p>Otras opciones</p>
          <p class="opacity-low">Comidas opcionales que usted quisiera solicitar</p>
        </div>
      </div>
    </div>
      </div> 
