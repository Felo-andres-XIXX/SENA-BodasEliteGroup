    ...
    <div align="center">
      <img src="css/img/elite.png" style="width: 20%">
             ...
             <div class="btn-group" style="width:100%">
              ...
              <br></br>
               <div class="texto"><center>Decoración</center>
               <br>
               </div>
              
                    <div class="btn-groupi" style="width:100%">
                            <a href="pistaled.php"><button style="width:19.663%"><h2>Pista Led</button></a></h2>
                            <br></br>
                            <br></br>
                            <a href="index.php"><button style="width:19.663%"><h2>Pantalla Led</button></a></h2>
                            <br></br>
                            <br></br>
                            <a href="index.php"><button style="width:19.663%"><h2>Hora Loca</button></a></h2>
                            <br></br>
                            <br></br>
                            <a href="index.php"><button style="width:19.663%"><h2>Lluvio de Sobres</button></a></h2>
                            <br></br>
                            <br></br>
                            <a href="index.php"><button style="width:19.663%"><h2>Fotografia y Video</button></a></h2>
                            <br></br>
                            <br></br>
                            <a href="index.php"><button style="width:19.663%"><h2>Bouquet</button></a></h2>
                            <br></br>
                            <br></br>
                            <br></br>
                      </div>
